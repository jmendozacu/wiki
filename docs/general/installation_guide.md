...
Step 3:
--------------------------------------
It&#39s required to disable cache in the administration panel of your site. Go to **System/Cache Management**. Select all caches and click **Disable** then submit.   
